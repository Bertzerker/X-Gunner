...
CFG="/media/fat/config/NES.zapper.CFG"
CFGDST="/media/fat/config/NES.CFG"
RACFG="/media/fat/config/RA_NES.zapper.CFG"
...
cp "$RACFG" "$RACFGDST"
sync
echo "X-GUNNER NES map set to Zapper"
echo "X-GUNNER RA_NES config set to Zapper"
